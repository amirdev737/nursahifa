...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VocabFlow — Learn English with flashcards" },
      { name: "description", content: "TikTok-style vocabulary flashcards with Uzbek translations, IPA, audio and AI examples." },
      { property: "og:title", content: "VocabFlow — Learn English with flashcards" },
      ...
      { name: "twitter:title", content: "VocabFlow — Learn English with flashcards" },
